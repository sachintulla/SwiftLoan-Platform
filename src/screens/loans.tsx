...
export default function Loans() {
  ...
  const open = (app: any, opts?: { offer?: any; lenderApp?: any }) => {
    // Always open the application tracker. A still-pending hand-off (the user
    // applied but never finished the lender/KFT web flow, so no webhook has
    // advanced it) gets a "Reapply" button ON the tracker that reopens the
    // lender web UI — we no longer auto-jump straight into the WebView.
    set({
