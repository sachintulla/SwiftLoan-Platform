 ...
 */
export function PanVerifyingLoader() {
  ...
  return (
    <div role="status" aria-live="polite" aria-label="Verifying your PAN" className="animate-rise-in flex flex-col items-center gap-8 py-4">
      ...
      <div className="text-center">
        <h1 className="text-2xl font-extrabold">Verifying your PAN</h1>
        <p className="text-muted-foreground mt-2 text-sm">Hang tight — this usually takes a few seconds</p>
      </div>
